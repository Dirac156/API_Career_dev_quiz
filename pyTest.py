...
topic_data = {
    ...
    "level": 1,
    "weight": 1,
    "choices": ["janesmith@gmail.com", "thatgirljay@gmail.com"], 
    "answer": 1
}
...
question_2 = {
    ...
    "level": 1,
    "weight": 1,
    "choice": ["Stick to 1 page and include and include the most relevant experiences","Include all your experiences and lay them out in as many pages as you need"],
    "answer" : 1
}
...
question_3 = {
    ...
    "level" : 2,
    "weight" : 1,
    "choice" : ["2017-2018: Program Manager","June 2017-December 2018:Program Manager at Best Company"],
    "answer" : 2
}
